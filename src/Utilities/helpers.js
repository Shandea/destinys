import cakeBlue from "../Assets/Images/CakeBlue.png";
import cookieChristmas from "../Assets/Images/CookieChristmas.png";
import cookieBrownie from "../Assets/Images/CookieBrownies.png";
import cakeWedding from "../Assets/Images/CakeWedding.png";
...
const data = {
  flipCardData: [
    {
      title: "Catering",
      text: "Deliciously crafted baked goods tailored for any event. Let us bring the joy of fresh treats to your table!",
      src: cakeBlue,
      alt: "A blue Cake",
      id: 1,
    },
    {
      title: "Holiday",
      text: "Make your holidays extra special with custom treats baked to perfection for every festive occasion.",
      src: cookieChristmas,
    ...
    {
      title: "Fundraising",
      text: "Partner with us to support your cause! We offer baked goods to help you raise funds for your community or organization.",
      src: cookieBrownie,
  ...
  cupCakeData: [
    ...
    },
    {
      ...
      id: 8,
      description:
        "A burst of summer freshness! These cupcakes are topped with a swirl of creamy purple frosting, a drizzle of blueberry glaze, and a crown of juicy blueberries. Each bite is a delightful explosion of sweet and tart flavors.",
    },
  ],
  ...
  cakeData: [
    ...
    },
    {
      ...
      id: 8,
      description:
        "A confection fit for a fairytale! This exquisite four-tiered cake is adorned with delicate lacework, cascading pearls, and a profusion of soft pink roses. It's a masterpiece of confectionery art that will leave your guests in awe.",
    },
  ],
  ...
  cookieData: [
    ...
    },
    {
      ...
      id: 2,
      description:
        "These festive thumbprint cookies are the perfect holiday treat! Soft and buttery cookies are topped with colorful sprinkles and a creamy Kiss for a delightful bite.",
    },
    {
    ...
    },
    {
      ...
      id: 8,
      description:
        "A classic for a reason! These soft and chewy sugar cookies are topped with a generous swirl of pink frosting and a sprinkle of colorful sprinkles. A simple yet delightful treat for any occasion.",
    },
  ],
